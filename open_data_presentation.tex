...
\setbeamertemplate{footline}{
  ...
  \hbox{
    \begin{beamercolorbox}[wd=.84\paperwidth,ht=2.5ex,dp=1ex,leftskip=1em]{author in head/foot}
      Open Data --- Sensory-Friendly Melbourne CBD Navigation
    \end{beamercolorbox}
...
\begin{frame}
  \titlepage
  \begin{block}{Purpose}
    Convert anonymous pedestrian observations and open geographic data into
    transparent crowd guidance for sensory-sensitive adults travelling through
    Melbourne CBD.
  \end{block}

  % Speaker notes:
  % Our data does not diagnose sensory overload or label a place as universally
  % safe. It provides evidence about one important stressor---pedestrian density---
  % so users can make a more informed and independent travel decision.
\end{frame}
